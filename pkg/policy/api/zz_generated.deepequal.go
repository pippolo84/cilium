...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CIDRGroupRefSlice) DeepEqual(other *CIDRGroupRefSlice) bool {
	if other == nil {
		return false
	}
...
func (in *IngressCommonRule) DeepEqual(other *IngressCommonRule) bool {
	...
	if ((in.FromCIDRGroupRef != nil) && (other.FromCIDRGroupRef != nil)) || ((in.FromCIDRGroupRef == nil) != (other.FromCIDRGroupRef == nil)) {
		in, other := &in.FromCIDRGroupRef, &other.FromCIDRGroupRef
		if other == nil || !in.DeepEqual(other) {
			return false
		}
	}
