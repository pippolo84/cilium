...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in CIDRGroupRefSlice) DeepCopyInto(out *CIDRGroupRefSlice) {
	{
		in := &in
		*out = make(CIDRGroupRefSlice, len(*in))
		copy(*out, *in)
		return
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CIDRGroupRefSlice.
func (in CIDRGroupRefSlice) DeepCopy() CIDRGroupRefSlice {
	if in == nil {
		return nil
	}
	out := new(CIDRGroupRefSlice)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *IngressCommonRule) DeepCopyInto(out *IngressCommonRule) {
	*out = *in
	...
	if in.FromCIDRGroupRef != nil {
		in, out := &in.FromCIDRGroupRef, &out.FromCIDRGroupRef
		*out = make(CIDRGroupRefSlice, len(*in))
		copy(*out, *in)
	}
